...
class ConfigureModuleService(AbstractService):

    def __init__(self, rpc_client):
        super(ConfigureModuleService, self).__init__(rpc_client)
    ...
    def handle(self, context):
        ...
        for flow_rule in configuration['flow_rules']:
            ...
            self.rpc_client.ask_agent_to_add_table_entry(self.rpc_ctx, table_id=table_id, table_entry=table_entry)
